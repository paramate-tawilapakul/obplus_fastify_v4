...
export const STORAGE_NAME = {
  ...
  lastActiveTabData4: `${APP_CONFIG.APP_NAME}_lastActiveTabData4`,
  Amniocentesis: `${APP_CONFIG.APP_NAME}_Amniocentesis`,
  CVS: `${APP_CONFIG.APP_NAME}_CVS`,
  Cordocentesis: `${APP_CONFIG.APP_NAME}_Cordocentesis`,
  IntrauterineTransfusion: `${APP_CONFIG.APP_NAME}_IntrauterineTransfusion`,
  activeProcedure: `${APP_CONFIG.APP_NAME}_activeProcedure`,
  cvl: `${APP_CONFIG.APP_NAME}_cvl`,
