...
function Amniocentesis({
  ...
  const CheckBox = (form, width = 200) => {
    ...
    if (form.name === 'Amniotic fluid test for') {
      if (cname === 'PCR') {
  ...
  return (
    <>
      ...
      <Box sx={{ m: inputMargin, width: '100%' }}>
        <InputTextField
          value={form[10].content?.split(' ')[0] || ''}
          handleChange={e => handleChange(e, form[10])}
          form={form[10]}
          endAdornment={
            <InputAdornment position='end'>
              <div>{form[10].unit}</div>
            </InputAdornment>
          }
        />
      </Box>
      ...
      <Box sx={{ m: inputMargin, width: '100%' }}>
        <SelectField
          value={form[12]?.contentOption || ''}
          handleChange={e => handleChange(e, form[12])}
          form={form[12]}
        />
        <InputTextField
          placeholder='Define...'
