...
const { getConsultant, getPatientOb } = require('../worklist/worklist.services')
const { getImages } = require('../dicom-images/dicom.image.services')
const { createPdf } = require('../pdf/pdf.services')
